...
SWIFT_CLASS("_TtC15ChattoAdditions18CompoundBubbleView") SWIFT_AVAILABILITY(ios,introduced=11)
@interface CompoundBubbleView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC15ChattoAdditions18InputContainerView")
@interface InputContainerView : UIInputView
- (void)layoutSubviews;
@property (nonatomic, readonly) CGSize intrinsicContentSize;
...
SWIFT_CLASS("_TtC15ChattoAdditions15PhotosInputView")
@interface PhotosInputView : UIView
...
@interface PhotosInputView (SWIFT_EXTENSION(ChattoAdditions)) <UICollectionViewDataSource>
...
@interface PhotosInputView (SWIFT_EXTENSION(ChattoAdditions)) <UICollectionViewDelegateFlowLayout>
